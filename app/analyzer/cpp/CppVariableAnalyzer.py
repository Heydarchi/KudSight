...
class CppVariableAnalyzer(AbstractAnalyzer):
    ...
    def analyze(self, filePath, lang=None, classStr=None):
        ...
        current_access = AccessEnum.PRIVATE # Default for C++ classes/structs if not specified
    ...
    def extractVariableInfo(self, inputString, match, current_access):
        ...
        variableInfo.isFinal = "const" in type_parts # Treat const as final for simplicity
