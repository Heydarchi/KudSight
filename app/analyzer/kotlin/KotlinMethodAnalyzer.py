...
class KotlinMethodAnalyzer(AbstractAnalyzer):
    ...
    def analyze(self, filePath, lang=None, classStr=None):
        ...
        while match:
            ...
            methodInfo.variables = KotlinVariableAnalyzer().analyze(None, None, content[match.start():match.end() + boundary])
    ...
    def extractMethodInfo(self, matchGroups):
        ...
        methodInfo.dataType = matchGroups[1].replace(":", "").strip() if matchGroups[1] else None
